...
class ProductListByCatagoryController extends GetxController {
  // Loading states
  ...
  Future<bool> getProductListByCatagory(int catagoryId) async {
    ...
    final NetworkResponse response = await Get.find<NetworkCaller>().getRequest(
      url: Urls.productdetailsById(catagoryId),
    );
